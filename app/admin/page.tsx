...
export default function AdminDashboard() {
  ...
  const exportCSV = () => {
    const headers = ["ID", "Patient Name", "Type", "Price", "Date", "Time", "Mobile", "Email", "Status"];
    const rows = filteredAppointments.map(a => [
      a.bookingId, `"${a.patientName}"`, a.appointmentType, a.price, 
      new Date(a.date).toLocaleDateString("en-IN"), a.timeSlot, a.mobile, a.email || "", a.status
    ]);
          ...
          <div className="w-full lg:w-[30%] bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-6">
            ...
            {selectedAppointment ? (
              ...
              <div className="text-center py-12 text-text-grey text-sm">
                ...
                Select an appointment to inspect patient details, edit, or delete.
              </div>
            )}
          </div>
        </div>
